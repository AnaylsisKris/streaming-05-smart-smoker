"""
    Food B Temperature Monitoring during cooking via "smart smoker"
        ...
        # process messages with values
            ...
            if len(temp_deque) == 21:
                ...
                if temp_change < 1.0:
                    ...
                    # send email alerts (not set up)
                    '''
                    email_subject = "FOOD-B STALL ALERT!"
                    email_body = (f"Food-B Temperature Change: {round(float(temp_change),1)} degrees. Time Change: {time_change} mins.")
